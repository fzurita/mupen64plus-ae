...
public class DownloadFromGoogleDriveService extends Service
{
    ...
    static class GameDownloadItem {
        ...
        final String gameDir3;
        final String romGoodName;
        final String romHeader;

        GameDownloadItem(String gameDir1, String gameDir2, String gameDir3, String romGoodName, String romHeader) {
            this.gameDir1 = gameDir1;
            this.gameDir2 = gameDir2;
            this.gameDir3 = gameDir3;
    ...
    private final class ServiceHandler extends Handler {
        ...
        public void handleMessage(@NonNull Message msg)
        {
            ...
            if (allData) {
                ...
                for ( final String md5 : mConfig.keySet() ) {
                    if (!ConfigFile.SECTIONLESS_NAME.equals(md5)) {
                        ...
                        if (crc != null && headerName != null && goodName != null && countryCode != null) {
                            ...
                            gamePrefs.useSecondAlternateGameDataDir();
                            String gameDataDirName3 = gamePrefs.getGameDataDirName();

                            GameDownloadItem downloadItem = new GameDownloadItem(gameDataDirName1, gameDataDirName2, gameDataDirName3, goodName, headerName);
                ...
                GameDownloadItem downloadItem = new GameDownloadItem(gameDataDirName1, gameDataDirName2, gameDataDirName3, mRomGoodName, mRomHeaderName);
                downloadItems.add(downloadItem);
            }
